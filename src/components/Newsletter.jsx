...
const Newsletter = () => {
    return (
        // <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto bg-neutralSilver my-8 py-16'>
            ...
            <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver py-16 mt-72'>
                <div className='flex items-center justify-center lg:w-2/5 mx-auto'>
                    ...
                    <a href="mailto:contact@sigma.com?subject=Objet">efficeinnovation@gmail.com</a>
