...
function Login() {
  ...
  return (
    <section className="h-full bg-neutralSilver py-0 mt-20 rounded-md">
      <div className="bg-Cprimary h-16 text-white font-poppins font-semibold text-4xl text-center py-4 ">
        {" "}
        Login
      </div>
        ...
        <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
          ...
          <div className="md:w-8/12 lg:ml-6 lg:w-5/12 ">
            <form ref={formRef}>
              ...
              <div className="mb-2 flex items-center justify-between mx-auto lg:mr-32 ">
                {" "}
                {/* sm:flex-row flex-col sm:items-center gap-1 */}
