...
const Home = () => {
  const blog = [{id:1, title:"Créer des processus de sauvegarde rationalisés", image:"/src/assets/image18.png"},{id:2, title:"Quelles sont vos responsabilités en matière d'immobilier", image:"/src/assets/image19.png"},{id:3, title:"Réorganiser le modèle de vos proprietes avec nos notre equipe", image:"/src/assets/image20.png"}, {id:4, title:"Créer des processus de sauvegarde", image:"/src/assets/image18.png"}];

  const explorez =[{id:1, title:"Terrains", descriptin:"  Ils sont des parcelles de terrain non développées, offrant aux acheteurs la possibilité de construire leur maison ou leur entreprise sur mesure.", image:"/src/assets/exploration/terrain.jpg ", alt:"image terrain", pageUrl:"/login"}, {id:2, title:"Villa", descriptin:"Elles sont des propriétés de luxe offrant un espace de vie spacieux et des équipements haut de gamme.", image:"/src/assets/exploration/villa.jpg", alt:"image villa", pageUrl:"/login"},{id:3, title:"Immeubles", descriptin:"Ils sont des propriétés résidentielles ou commerciales comprenant plusieurs unités. Ils sont un excellent investissement pour les propriétaires cherchant à générer des revenus locatifs.", image:"/src/assets/exploration/immeuble.jpg", alt:"image immeuble", pageUrl:"/login"},{id:4, title:"Appartements", descriptin:"Ils offrent un espace de vie pratique et confortable pour les individus et les familles.", image:"/src/assets/exploration/appartement.jpg", alt:"image appatement", pageUrl:"/login"},{id:5, title:"Magasins", descriptin:"Ils sont des espaces commerciaux destinés à la vente au détail. Ils varient en taille et en emplacement, offrant aux commerçants un lieu idéal pour établir leur entreprise.", image:"/src/assets/exploration/magasin.jpg" , alt:"immage magasin", pageUrl:"/login"},{id:6, title:"Hotel", descriptin:"Ils sont conçus pour offrir un séjour confortable et pratique aux clients, que ce soit pour les voyages d'affaires ou de loisirs.", image:"/src/assets/exploration/studio.jpg",alt:"immage hotel", pageUrl:"/login"},{id:7, title:"Bureaux", descriptin:"Ils offrent un environnement professionnel pour le travail, avec différentes configurations allant des espaces de travail partagés aux bureaux privés.", image:"/src/assets/exploration/bureau.jpg", alt:"image bureau"},{id:8, title:"Projets architecturaux ", descriptin:"Projets Architecturaux : C'est sont des plans et des conceptions pour de futurs bâtiments et structures.", image:"/src/assets/exploration/duplex.jpg", alt:"imge projet archi", pageUrl:"/login"},]
  ...
  return (
    <div className=' h-full '>
      <div className='px-0 lg:px-0 py-20  relative'>
        ...
        <Carousel className='custom-carousel custom-carousel-image'
          showStatus={false}
          showThumbs={false}
          centerMode
          dynamicHeight
      ...
      <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver w-screen py-0 -mt-12'>

        <div className='text-center md:-end-1/2 mx-auto'>
            <h2 className='text-4xl font-semibold mb-4 text-Csecondary1 pt-7 '>Explorez le monde immobilier</h2>

            </div>
        <div className='grid lg:grid-cols-4 gap-x-2 mb-20 mt-7'>
           
            {
            explorez.map(explorez => (
            <div key={explorez.id} className='w-full md:w-2/3 lg:w-full h-full mx-auto rounded-2xl  hover:scale-95 transition-all duration-300'>
                    
                    <a href={explorez.pageUrl}>
                    <div className='relative w-64 h-64 ml-4 lg:left-7'>
                        <img
                        src={explorez.image}
                        alt='Mes biens immobiliers'
                        className='bg-Csecondary1 absolute top-0 left-0 h-full w-full object-cover z-0 rounded-full shadow-2xl mb-20 border border-Csecondary1'
                        />
                    </div>
                    </a>
        ...
        <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto  w-screen py-2 '>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                <div className='md:w-1/2  -mt-10'>
                    ...
                    <p className='md:w-2/3 text-xl text-texteCouleur font-serif mb-8 text-center ' > Se connecter pour une expérience plus personnalisée </p>
                ...
                <img src={Accampagnement} alt='Mes biens immobiliers'  className='rounded-md shadow-2xl mb-20 border border-Csecondary1'></img>
                </div>
               
            </div>
           
            <div className='text-center md:-end-1/2 mx-auto '>
                <h2 className="text-3xl font-semibold mb-4 font-poppins text-Csecondary1 items-center flex justify-center">Comment ça marche ?  </h2>
        ...
        <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto  bg-neutralSilver  w-screen py-2 '>
            <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
                <div className='md:w-1/2 '>
                    {/* <h2 className='text-3xl font-semibold font-poppins mb-4 text-Csecondary1 md:w-2/3 text-center'>Obtenez des recommandations </h2> */}
                    <p className='md:w-2/3 text-2xl font-bold text-texteCouleur font-serif mb-8 text-center ' > Devenez propriétaire d'un bien en moins de <span className='text-Csecondary1'> 5 min </span> top chrono !</p>
                 {/* <button className="bg-Csecondary1 lg:flex items-center flex justify-center text-white py-2 px-4  transition-all duration-300 rounded hover:bg-Cprimary animate ml-40 font-poppins text-base"> <a href="/login">Se connecter</a> </button> */}
        ...
        <div className='text-center md:-end-1/2 mx-auto p-10  '>
            <h2 className="text-3xl font-semibold mb-4 font-poppins text-Csecondary1 items-center flex justify-center">Actualité sur l'immobilier </h2>
                <p className='text-xl font-serif text-texteCouleur'>Suivre en temps réel les nouvelles sur les biens immobilier</p>
        </div>
        ...
        <div className='px-4 lg:px-14 max-w-screen-2x1 mx-auto bg-neutralSilver w-screen py-2 mt-0'> 
          <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-0 mt-4'>
            ...
            <div className='grid lg:grid-cols-4 sm:grid-cols- grid-cols-1 gap-7 items-center justify-between'>
                ...
                blog.map(blog => (
                    <div key={blog.id} className='mx-auto relative mb-12 cursor-pointer .hover:scale-110'>
                    ...
                    <h3 className='mb-3 text-Cprimary font-semibold'>{blog.title}</h3>
                <div className='flex items-center justify-center gap-8'>
                    <a href="/" className='font-bold text-base text-Cprimary hover:text-Csecondary1 flex items-center'>
                    En savoir plus
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" viewBox="0 0 25 11" fill="none" className='ml-0'>
                        <path d="M12 9.39905L15.2929 6.10615C15.6834 5.71563 15.6834 5.08246 15.2929 4.69194L12 1.39905M15 5.39905ML1 5.39905" stroke="#1d4e9c" />
                        </svg>
                    </a>
